                        ...
                        <div className="w-full max-w-sm p-6 m-auto mx-auto ">
                            ...
                            <form className="mt-6">
                                <div>
                                    ...
                                    <input type="text" className="block w-full px-4 py-2 mt-1 text-gray-700 bg-white border rounded-lg  focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>

                                <label for="username" className="mt-3 block text-sm text-white dark:text-gray-200">Profile Photo</label>
                                <label for="dropzone-file" className="flex items-center px-3 py-5 mt-1 mx-auto text-center bg-white border-2  rounded-lg cursor-pointer dark:border-gray-600 dark:bg-gray-900">
                                ...
                                <div className='mt-3'> 
                                    ...
                                    <input type="email" className="block w-full px-4 py-2 mt-1 text-gray-700 bg-white border rounded-lg  focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                                <div className="mt-3">
                                    ...
                                    <input type="password" className="block w-full px-4 py-2 mt-1 text-gray-700 bg-white border rounded-lg  focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                            ...
                            <div className="flex items-center mt-6 -mx-2">
                                <button type="button" className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-[#610b0b] rounded-lg hover:bg-[#440a0a] focus:bg-blue-400 focus:outline-none">
